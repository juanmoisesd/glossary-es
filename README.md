...
**APA 7**
> De la Serna Tuya, J. M. (2025). *🇪🇸 Glosario Científico — de la Serna Tuya, Juan Moisés · ORCID 0000-0002-8401-8018* [Dataset]. GitHub. https://github.com/juanmoisesd/glossary-es

**BibTeX**
```bibtex
@dataset{delaserna2025_glossary_es,
  author    = {De la Serna Tuya, Juan Moisés},
  title     = {🇪🇸 Glosario Científico — de la Serna Tuya, Juan Moisés · ORCID 0000-0002-8401-8018},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/glossary-es},
...
> de la Serna, J. M. (2026). *Glossary Es*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/glossary-es 10.5281/zenodo.19145316

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **glossary es**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
